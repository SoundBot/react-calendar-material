...
require(_path2.default.resolve('./index.css'));
var ic_back = require(_path2.default.resolve('./ic_back.svg'));
var ic_forward = require(_path2.default.resolve('./ic_forward.svg'));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'month' },
            _react2.default.createElement('img', { className: 'month-arrow-left', src: ic_back, alt: 'back', onClick: this.prev.bind(this) }),
            _react2.default.createElement(
              'p',
            ...
            _react2.default.createElement('img', { className: 'month-arrow-right', src: ic_forward, alt: 'forward', onClick: this.next.bind(this) })
          ),
          _react2.default.createElement(
            'div',
            { className: 'footer' },
